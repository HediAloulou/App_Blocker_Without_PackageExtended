...
public class SensorService extends Service implements SensorEventListener {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        if (rotationSensor == null) {
            ...
            boolean rotationSensorRegistered = sensorManager.registerListener(this, rotationSensor, SensorManager.SENSOR_DELAY_NORMAL);
            if (!rotationSensorRegistered) {
                Log.e(TAG, "Failed to register rotation sensor listener");
            }
        }
        ...
        if (linearAccelerationSensor == null) {
            ...
            boolean linearAccelerationSensorRegistered = sensorManager.registerListener(this, linearAccelerationSensor, SensorManager.SENSOR_DELAY_NORMAL);
            if (!linearAccelerationSensorRegistered) {
                Log.e(TAG, "Failed to register linear acceleration sensor listener");
            }
        }
    ...
    private void calculateAndSendResult() {
        ...
        // Unregister sensor listeners after measurement duration
